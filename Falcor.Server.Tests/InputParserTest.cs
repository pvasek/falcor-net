...
namespace Falcor.Server.Tests
{
    public class InputParserTest
    {
        ...
        {
            var target = new InputParser();
            var result = target.ParseInput("[ 'events' , 'name']");
        ...
        {
            var target = new InputParser();
            var result = target.ParseInput("[ 10 , 22]");
        ...
        {
            var target = new InputParser();
            var result = target.ParseInput("[ 10..15 , 3...30]");
        ...
        {
            var target = new InputParser();
            var result = target.ParseInput("[ 'events' , 10, 0..50, 'name', 22]");
        ...
        {
            var target = new InputParser();
            var result = target.ParseInput("[ 'events',0..5, ['name', 'order']]");
